  ...
  fillNeighborhoodsHTML = (neighborhoods = self.neighborhoods) => {
    ...
    select.setAttribute('aria-lable', 'Filter by neigbourhood');
  ...
  initMap = () => {
    ...
    L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
      mapboxToken: 'pk.eyJ1Ijoic2F0YXJzeSIsImEiOiJjano5bnVzOXgwMzF5M21tdjc0cWYzdG9wIn0.b9ZahVpvMe7jdJvZ6AgkOg',
      maxZoom: 18,
